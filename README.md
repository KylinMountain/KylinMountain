...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="assets/hero-dark.svg?v=20260713" />
  <img width="100%" src="assets/hero-light.svg?v=20260713" alt="Kylin — PageIndex · OpenKB Maintainer, GraphRAG & SGLang Contributor" />
</picture>
...
| Role | Project | | What |
|---|---|---|---|
| ![](https://img.shields.io/badge/MAINTAINER-F4C455?style=flat-square&labelColor=0D1117) | [**VectifyAI / PageIndex**](https://github.com/VectifyAI/PageIndex) | <!--star:VectifyAI/PageIndex-->**★ 34k**<!--/star--> | Vectorless, reasoning-based retrieval for long documents — no vector DB, no chunking |
