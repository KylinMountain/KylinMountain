...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="assets/hero-dark.svg?v=20260805" />
  <img width="100%" src="assets/hero-light.svg?v=20260805" alt="Kylin — PageIndex · OpenKB Maintainer, GraphRAG & SGLang Contributor" />
</picture>
...
| Role | Project | | What |
|---|---|---|---|
| ![](https://img.shields.io/badge/MAINTAINER-F4C455?style=flat-square&labelColor=0D1117) | [**VectifyAI / PageIndex**](https://github.com/VectifyAI/PageIndex) | <!--star:VectifyAI/PageIndex-->**★ 35k**<!--/star--> | Vectorless, reasoning-based retrieval for long documents — no vector DB, no chunking |
...
| ![](https://img.shields.io/badge/CONTRIBUTOR-38E0C8?style=flat-square&labelColor=0D1117) | [**sgl-project / sglang**](https://github.com/sgl-project/sglang) | <!--star:sgl-project/sglang-->**★ 31.3k**<!--/star--> | Docker image fix shipped upstream ([#1520](https://github.com/sgl-project/sglang/pull/1520)) |
